...
export class SeedDoctorProfiles1635500010500 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    VALUES 
      ('Natasha', 'Yelin Chang', 'female', '2002-01-01T15:00:00.000Z', '21ed452e-b3da-47d6-bd0c-8abea993cf0b');

    INSERT INTO profile.profiles (first_name, last_name, gender, birth_date, user_id) 
    VALUES 
      ('Laura', 'Les', 'female', '2002-01-01T15:00:00.000Z', 'abd9a3f6-acd5-450a-9961-3ffba92f20e6');

    INSERT INTO profile.profiles (first_name, last_name, gender, birth_date, user_id) 
    VALUES 
      ('Valentin', 'Strykalo', 'male', '2002-01-01T15:00:00.000Z', 'c1414d7c-cd5d-4d1a-9c29-7311bb21c884');

    INSERT INTO profile.profiles (first_name, last_name, gender, birth_date, user_id) 
    VALUES 
      ('Thom', 'Yorke', 'male', '2002-01-01T15:00:00.000Z','65c7bf31-c24d-42c8-bd4f-1ceee57496b2');
